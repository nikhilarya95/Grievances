...
<div style="width:49%;float:right;"class="col-sm-6">
<?php echo  form_input(['class'=>"form-control ",'type'=>"text",'id'=>"",'name'=>'Faculty_id','placeholder'=>"Faculty_id"])?>
            ...
            <div class="rows">
                <div class="col-sm-4"style="width:24%;float:left;padding:0%">
                    <select class="form-control col-sm-3" name="tle1"style="" >
                        <option >Mr</option>
                        <option >Dr</option>
                        <option >Miss</option>
                    </select> 
                ...
                <div class="col-sm-4"style="padding:2px;width:38%;float:left;">
                ...
                <div class="col-sm-4" style="padding:2px;width:38%;float:right;">
                 ...
                 <div style="margin-left:12%;float:left;padding-right:2%;"><?php echo form_error('firstname') ?>
            </div>
 ...
 <button  Style="color:white;margin-left:75%;" type='submit' href="b" class='btn btn-primary' value="sign_submit" data-toggle='modal' data-target='#myModal'>
         Verify</button>
...
<!--<button Style="color:white;margin-left:75%;"class="btn btn-info" id="h"><a Style="color:white; font-size:15px;text-decoration:none;" href="http://localhost/kec1/index.php/user/home">Verify</a>
	...
	<div id="new" class="text-center small">Already have an account? <a href="http://localhost/kec1/index.php/user/home">Login here</a></div>
    </div>
    </div>
    </div>
