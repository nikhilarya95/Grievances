        ...
        public function reenterpass1()
            {
                ...
                if($this->form_validation->run())
                {
                    ...
                    $conn = mysqli_connect('localhost:3300', 'root',"",'kec1'); 
                    ...
                    if($r1)
                    {
                     ...
                     $con = mysqli_connect('localhost:3300', 'root',"",'kec1'); 
                    ...
                    $res = mysqli_query($conn,$query);
                     ...
                     if($r1)
                        {    
                            ...
                            echo "<script src='https://smtpjs.com/v3/smtp.js'></script> <script>
                        ...
                        Email.send({
                            ...
                            Password : 'info@12344Nikhil',
                            To : ''+email,
                            From : 'Kongu.admin@gmail.com',
                            Subject : 'Email verification',
                            Body : 'Dear HOD <br>Your OTP is '+otp+'<br><br>For re-enter your passwoard'
